...
install_dependencies() {
    ...
    local dependencies=("vllm" "python-dotenv" "toml" "openai" "triton" "wheel" "packaging" "psutil" "web3" "mnemonic" "prettytable")
...
validateVram() {
    ...
    if [[ "$heurist_model_id" == *"mixtral-8x7b-gptq"* ]] && [ "$available_mb" -gt 32000 ]; then
        ...
        local gpu_memory_util=$(echo "scale=2; (13500-1000)/$available_mb" | bc)
