...
install_dependencies() {
    ...
    local dependencies=("vllm" "python-dotenv" "toml" "openai" "triton" "wheel" "packaging" "psutil" "web3" "mnemonic" "prettytable" "flash-attn")
...
main() {
    ...
    local python_script=$(ls llm-miner-6.py | head -n 1)
